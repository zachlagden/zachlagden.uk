        ...
        <div className="grid lg:grid-cols-[1fr_250px] gap-12">
          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="h-12 w-3/4 bg-neutral-200 dark:bg-neutral-800 rounded animate-pulse" />
            </div>

            {/* Excerpt skeleton */}
            <div className="space-y-2 mb-6">
              <div className="h-6 bg-neutral-200 dark:bg-neutral-800 rounded animate-pulse" />
            ...
            <div className="aspect-video w-full bg-neutral-200 dark:bg-neutral-800 rounded-lg animate-pulse mb-8" />
