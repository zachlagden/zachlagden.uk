    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <div className="border-b border-neutral-200 dark:border-neutral-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="h-10 w-32 bg-neutral-200 dark:bg-neutral-800 rounded mb-4 animate-pulse" />
          <div className="h-6 w-full max-w-2xl bg-neutral-200 dark:bg-neutral-800 rounded animate-pulse" />
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-[1fr_300px] gap-8">
          ...
          <aside className="lg:sticky lg:top-8 h-fit">
            <div className="border border-neutral-200 dark:border-neutral-700 rounded-lg p-6">
              <div className="h-6 w-20 bg-neutral-200 dark:bg-neutral-800 rounded mb-4 animate-pulse" />
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-8 w-24 bg-neutral-200 dark:bg-neutral-800 rounded-full animate-pulse"
                    />
                  ))}
                </div>
              </div>
