      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16 xl:px-0 relative">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="space-y-2 text-center md:text-left">
            ...
            <div className="text-xs text-neutral-400 font-mono-accent flex items-center justify-center md:justify-start">
          ...
          <div className="space-y-4 flex flex-col items-center md:items-end">
            ...
            >
              <a
                ...
                className="text-neutral-400 hover:text-[#24292e] transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 rounded p-1"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-[#0077b5] transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 rounded p-1"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-[#e4405f] transition-colors focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 rounded p-1"
