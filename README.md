...
```bash
git clone https://github.com/yourusername/cv.zachlagden.uk.git
cd cv.zachlagden.uk
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fyourusername%2Fcv.zachlagden.uk)
